...
<nav class="navbar">
    ...
    <?php if ($user): ?>
        <div class="btn_nav">
            ...
            <a href="/kompetisi"><i class="bi bi-trophy"></i>Kompetisi</a>
            <a href="/lost_found"><i class="bi bi-box-seam"></i>Lost & Found</a>
            <a href="/event"><i class="bi bi-calendar4"></i>Event</a>
            <a href="/forum"><i class="bi bi-chat-left"></i>Forum</a>
        </div>
