        ...
        <div class="competitions-grid">
            <?php if (!empty($datas)): ?>
                <?php foreach ($datas as $data): ?>
                    <div class="competition-card" data-category="<?= htmlspecialchars($data['kategori']) ?>">
                        <div class="card-header">
                            <div class="card-title">
                                <span class="trophy-icon">📦</span>
                                <h3><?= htmlspecialchars($data['nama_barang']) ?></h3>
                            </div>
                            <span class="category-badge ver-<?= htmlspecialchars($data['kategori']) ?>">
                                <?= ucfirst(htmlspecialchars($data['kategori'])) ?>
                            </span>
                        </div>
                        <p class="card-description"><?= htmlspecialchars($data['deskripsi']) ?></p>
                        <div class="card-details">
                            ...
                            <div class="detail-item">
                                ...
                                <span><?= timeAgo($data['tanggal']) ?></span>
                            </div>
                            <div class="detail-item">
                                <svg class="detail-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="card-description dibuat-oleh">
                                Dilaporkan oleh: <?= htmlspecialchars($data['username'] ?? 'Unknown') ?>
                            </span>
                        </div>
                    </div>
                <?php endforeach; ?>
