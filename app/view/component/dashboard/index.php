        ...
        <div class="dashboard-container">
            ...
            <header class="dashboard-header">
                ...
                <div class="header-actions">
                    <button class="notification-btn" onclick="alert('Fitur notifikasi segera hadir!')">
                                ...
                                <div class="feed-card">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <?php if (!empty($post['title'])): ?>
                                            <h3 style="font-size: 16px; margin-bottom: 8px;"><?= htmlspecialchars($post['title']) ?></h3>
                                        <?php endif; ?>
                                        <?php if (!empty($post['content'])): ?>
                                            <p><?= htmlspecialchars($post['content']) ?></p>
                                        <?php endif; ?>
                                        <?php if (!empty($post['category'])): ?>
                                            <span class="event-badge competition" style="display: inline-block; margin-top: 8px;">
